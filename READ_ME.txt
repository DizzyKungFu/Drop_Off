...
##
## 1.3.0    updated to work with Cosmos .exe version 1.3.0 (using MAST libraries 1.3.0)
##          added a description.yaml file, which is new to this version of the game
...
##
## Future:  update nebulae to use new (non-test) spawn functions? Find a way to get dark blue nebulae with the new functions? (test functions in tile.py still work, but are dated)
