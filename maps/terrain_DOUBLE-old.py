...
def terrain_spawn_stations(DIFFICULTY, lethal_value, x_min=-99_000, x_max=99_000, center=None, min_num=0, points=None):
    ...
    _station_weights  = {"starbase_industry": 4,"starbase_command": 3,"starbase_civil": 1,"starbase_science": 1}
...
def terrain_asteroid_clusters(terrain_value, center=None, selectable=True, points=None):
    """
    ...
    t_max = t_min * 2
    if points is None:
        spawn_points = scatter.box(random.randint(t_min,t_max), center.x, center.y, center.z, 200_000, 2000, 200_000, centered=True)
    else:
...
def terrain_spawn_asteroid_sphere(x,y,z, radius=10000, density_scale=1.0, density=1, height=1000, selectable=True):
    """
...
def terrain_spawn_black_holes(lethal_value, center=None, points=None):
    ...
    if points is None:
        spawn_points = scatter.box(lethal_value, center.x,center.y, center.z, 200_000, 1000, 200_000, centered=True)
