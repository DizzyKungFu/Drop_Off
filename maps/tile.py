...
def test_spawn_asteroid_box(x,y,z, size_x=10000,size_z=None, density_scale=1.0, density=1, height=1000):
    ...
    cluster_spawn_points = scatter.box(amount,  x + size_x/2, 0, z+size_z/2, size_x, height, size_z, True, 0, 0, 0 )
...
def test_spawn_nebula_common(cluster_spawn_points, height):
    for v2 in cluster_spawn_points:
        ...
        nebula.blob.set("max_throttle", 2.0)
        nebula.blob.set("unselectable", 1)
        nebula.blob.set("nebula_data_change", 1)
